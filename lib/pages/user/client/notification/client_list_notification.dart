...
class ClientNotificationListPage extends StatefulWidget {
  final String token;

  ClientNotificationListPage({required this.token});

  @override
  _ClientNotificationListPageState createState() =>
      _ClientNotificationListPageState();
}

class _ClientNotificationListPageState
    extends State<ClientNotificationListPage> {
