...
class VADetailPage extends StatefulWidget {
  final String userIdVa;
  const VADetailPage({super.key, required this.userIdVa});

  @override
  State<VADetailPage> createState() => _VADetailPageState();
}

class _VADetailPageState extends State<VADetailPage> {
  ...
  Future<void> checkMyUser() async {
    ...
    String _myPhotoUser = prefs.getString('profileImage') ?? '';
    setState(() {
      myUserId = '$_myIdUser';
      myUserName = '$_myNameUser';
      myUserPhoto = '$_myPhotoUser';
      //myUserId = '59';
    });

    print('widget.userIdVa ${widget.userIdVa}');
    print('myUserId $myUserId');
    print('myUserPhoto $myUserPhoto');
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                    '${userProfile['ratingAsClient'] == null || userProfile['ratingAsClient'] == 'null' ? '5.0' : userProfile['ratingAsClient']}',
                                    overflow: TextOverflow.ellipsis,
                                    style:
                                        LText.subtitle(color: LColors.black)),
                              )
                            ],
                          ),
                          GapCInput(),
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          ...
                          builder: (context) => VAChatPage(
                                ...
                                userName: '$myUserName',
                                lawanBicara: '${userProfile['fullName']}',
                                lawanBicaraPhoto:
