...
import 'package:letter_a/pages/user/client/contract/contract_list_page.dart';
import 'package:letter_a/pages/user/client/message/list_message.dart';
import 'package:letter_a/pages/user/client/offer/list_offer_page.dart';
...
class ListMessagePage extends StatefulWidget {
  final String index;
  ListMessagePage({Key? key, this.index = ''}) : super(key: key);
