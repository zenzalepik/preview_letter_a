...
import 'package:letter_a/pages/user/va/auth/google/login_process_google_page.dart';
import 'package:letter_a/pages/user/va/auth/google/register_google_page.dart';
...
class FreeProfilePage extends StatefulWidget {
  ...
  @override
  _FreeProfilePageState createState() => _FreeProfilePageState();
}

class _FreeProfilePageState extends State<FreeProfilePage> {
  ...
  Future<void> _inisiasi() async {
    setState(() {
      // _idController.text = '${widget.freeUserProfile.id}';
    ...
    try {
      ...
      if (result['status'] == '001') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => FreeLoginBerhasil(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => FreeUserFormPage(freeUserProfile: widget.freeUserProfile),
          ),
        );
      } else {
        final data = result['data'];
