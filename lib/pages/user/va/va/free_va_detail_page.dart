...
class FreeVADetailPage extends StatefulWidget {
  final String userIdVa;
  const FreeVADetailPage({super.key, required this.userIdVa});

  @override
  State<FreeVADetailPage> createState() => _FreeVADetailPageState();
}

class _FreeVADetailPageState extends State<FreeVADetailPage> {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                    '${userProfile['rating'] == null || userProfile['rating'] == 'null' ? '5.0' : userProfile['rating']}',
                                    overflow: TextOverflow.ellipsis,
                                    style:
