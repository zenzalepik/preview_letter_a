...
class FreeStatistikPage extends StatefulWidget {
  const FreeStatistikPage({super.key});

  @override
  State<FreeStatistikPage> createState() => _FreeStatistikPageState();
}

class _FreeStatistikPageState extends State<FreeStatistikPage> {
  List _data = [];
  String token = 'b';
