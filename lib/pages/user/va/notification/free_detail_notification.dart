...
class VANotificationDetailPage extends StatefulWidget {
  final String token;
  final int notificationId;

  VANotificationDetailPage(
      {required this.token, required this.notificationId});

  @override
  _VANotificationDetailPageState createState() =>
      _VANotificationDetailPageState();
}

class _VANotificationDetailPageState
    extends State<VANotificationDetailPage> {
