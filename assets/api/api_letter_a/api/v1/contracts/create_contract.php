...
if (mysqli_num_rows($result) == 1) {
    ...
    $sql = "INSERT INTO contracts (UserID, Vaid, TanggalMulai, TanggalBerakhir, Gaji, DeskripsiPekerjaan)
            VALUES ('$userID', '$vaid', '$tanggalMulai', '$tanggalBerakhir', '$gaji', '$deskripsiPekerjaan')";
